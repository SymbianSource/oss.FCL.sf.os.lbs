...
/**
 ...
 @internalTechnology
*/
#if (!defined __SUPLCONNECTIONMANAGER1_STEP_H__)
#define __SUPLCONNECTIONMANAGER1_STEP_H__
#include <test/testexecutestepbase.h>
#include "Te_suplconnectionmanagerSuiteStepBase.h"

class Csuplconnectionmanager1Step : public CTe_suplconnectionmanagerSuiteStepBase
	{
public:
	Csuplconnectionmanager1Step();
	~Csuplconnectionmanager1Step();
...
_LIT(Ksuplconnectionmanager1Step,"suplconnectionmanager1Step");
